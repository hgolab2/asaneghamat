<?php defined('ABSPATH') or die();
	...
	class rsssl_csp_backend
	{
		...
		public function csp_notices($notices){
            ...
            if ( rsssl_get_option( 'csp_status' ) === 'learning_mode' ) {
	            ...
	            $notices['learning_mode_active'] = array(
		            ...
		            'output' => array(
			            'true' => array(
				            'msg' => sprintf(__("Learning Mode is active for your Content Security and will complete in %s days.", "really-simple-ssl"), $days),
				            'icon' => 'open',
				            'plusone' => true,
				            'dismissible' => true
			            ),
		...
		public function update_db_check()
		{
			...
			if ( get_option('rsssl_csp_db_version') !== rsssl_version ) {
				...
				dbDelta($sql);
				update_option('rsssl_csp_db_version', rsssl_version);
			}
		}
