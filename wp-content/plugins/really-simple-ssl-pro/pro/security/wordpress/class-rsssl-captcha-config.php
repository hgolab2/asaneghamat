...
require_once rsssl_path . 'pro/security/wordpress/captcha/class-rsssl-captcha-provider.php';
...
use REALLY_SIMPLE_SSL\Security\WordPress\Captcha\Rsssl_Captcha_Provider;
use REALLY_SIMPLE_SSL\Security\WordPress\Captcha\Rsssl_HCaptcha;
use REALLY_SIMPLE_SSL\Security\WordPress\Captcha\Rsssl_ReCaptcha;
...
//		add_filter( 'rsssl_notices', array( $this, 'show_captcha_notices' ), 10, 1 );
	...
	public function get_set_provider(): object {
		...
		if ( ! rsssl_get_option( 'enabled_captcha_provider' ) ) {
			rsssl_update_option( 'enabled_captcha_provider', 'none' );
		}

		return $providers[ rsssl_get_option( 'enabled_captcha_provider' ) ];
	}
