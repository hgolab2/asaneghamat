...
if (!class_exists("rsssl_licensing")) {
	class rsssl_licensing {
		...
		public function add_license_to_localize_script($variables) {
			...
			$variables['url'] = $url;
			$variables['messageInactive'] = __("Your Really Simple SSL Pro license hasn't been activated.","really-simple-ssl");
			$variables['messageInvalid'] = __("Your Really Simple SSL Pro license is not valid.","really-simple-ssl");
			return $variables;
		}
		...
		public function get_notices_list( array $notices)
		{
			...
			$notices['rsssl_pro_license_valid'] = array(
				...
				'output' => array(
					'expired' => array(
						'title' => __("License", 'really-simple-ssl'),
						'msg' => __("Your Really Simple SSL Pro license key has expired. Please renew your license to continue receiving updates and premium support.", "really-simple-ssl").$link,
						'icon' => 'warning',
						'plusone' => true,
						'admin_notice' => false,
					),
					'invalid' => array(
						'title' => __("License", 'really-simple-ssl'),
						'msg' => __("Your Really Simple SSL Pro license key is not activated. Please activate your license to continue receiving updates and premium support.", "really-simple-ssl").$activate,
						'icon' => 'warning',
						'plusone' => true,
						'admin_notice' => false,
					),
					'site_inactive' => array(
						'title' => __("License", 'really-simple-ssl'),
						'msg' => __("This domain is not activated for this Really Simple SSL Pro license. Please activate the license for this domain.", "really-simple-ssl").$link,
						'icon' => 'warning',
						'plusone' => true,
						'admin_notice' => false,
					),
					'no_activations_left' => array(
						'title' => __("License", 'really-simple-ssl'),
						'msg' => __("You do not have any activations left on your Really Simple SSL Pro license. Please upgrade your plan for additional activations.", "really-simple-ssl").$link,
						'icon' => 'warning',
						'plusone' => false,
						'admin_notice' => false,
					),
					'not-activated' => array(
						'title' => __("License", 'really-simple-ssl'),
						'msg' => __("Your Really Simple SSL Pro license key hasn't been activated yet. You can activate your license key on the license tab.", "really-simple-ssl").$activate,
						'icon' => 'warning',
						'plusone' => true,
						'admin_notice' => false,
					),
			...
			$notices['rsssl_pro_single_site_on_multisite'] = array(
				...
				'output' => array(
					'true' => array(
						'title' => __("License", 'really-simple-ssl'),
						'msg' => __("You are using Really Simple SSL Pro single site on a multisite environment. Please install Really Simple SSL multisite networkwide for multisite support.", "really-simple-ssl").$link,
						'icon' => 'warning',
						'plusone' => true,
						'admin_notice' => true,
					),
