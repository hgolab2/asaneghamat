 ...
 * @package RSSSL_PRO\Security\WordPress\Eventlog
 */

namespace RSSSL_PRO\Security\WordPress\Eventlog;
...
class Rsssl_Event_Type {
	...
	public static function get_short_description_based_on_code( string $code ): string {
		if ( '1051' === $code || '1052' === $code ) {
			// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
			error_log( 'get_short_description_based_on_code as string: ' . $code );
		}
