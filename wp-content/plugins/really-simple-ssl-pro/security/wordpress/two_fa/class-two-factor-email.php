...
class Rsssl_Two_Factor_Email extends Rsssl_Two_Factor_Provider {
	...
	public function generate_and_email_token( WP_User $user ): void {
		...
		$skip_button_html = sprintf(
			'<a href="%s" class="button" style="padding: 10px 30px; background: #2A7ABF; border-color: #2A7ABF; color: #fff; text-decoration: none; text-shadow: none; display: inline-block; margin-top: 15px; font-size: 0.8125rem; font-weight: 300; transition: all .3s ease; min-height: 10px;">' . __("Continue", "really-simple-ssl-pro") . '</a>',
