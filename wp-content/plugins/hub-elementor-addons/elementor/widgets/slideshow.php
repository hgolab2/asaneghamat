					...
					<div class="flickity-slider d-flex w-100 h-100" style="<?php echo $origin ?>: 0; transform: translateX(0%);">
						...
						if ( $settings['identities'] ) {
							...
							foreach ( $settings['identities'] as $slide ) {
								$lightbox_url = isset( $slide['url']['url'] ) && !empty( $slide['url']['url'] ) ?
									$slide['url']['url'] :
									wp_get_attachment_image_url( $slide['image']['id'], 'full', false );
							...
							<div class="carousel-item-inner pos-rel w-100">
								<div class="carousel-item-content pos-rel w-100">
									...
									data-slideelement-options='{ "visibleElement": "h2", "hiddenElement": "p, .lqd-slsh-btn" }'>
										...
										<?php if($settings['lqd_slideshow_lightbox'] === 'yes') : ?>
										<a href="<?php echo $lightbox_url ?>" class="fresco lqd-overlay pos-abs w-100 h-100 pos-tl" data-fresco-group="lqd-slideshow-<?php echo $this->get_id() ?>-gallery"></a>
										<?php endif; ?>
									</div>
