...
$this->sections[] = array(
    ...
    'fields' => array(
        array(
            ...
            'description' => wp_kses_post( '<div class="notice-yellow">این گزینه برای کاهش حجم فایل های CSS و JS استفاده می شود. پس از فعال سازی، همه فایل ها به طور جداگانه بنا به نیاز صفحه شما فراخوانی می شوند. فایل های JS را می توان از طریق گزینه کارایی > JS > فشرده JS ترکیب کرد. لطفا توجه داشته باشید که فایل های CSS به طور خودکار ترکیب می شوند.</div>', 'hub' ),
            'options'  => array(
