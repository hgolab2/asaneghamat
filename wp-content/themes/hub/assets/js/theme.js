  ...
  $.fn[pluginName] = function (options) {
    return this.each(function () {
      ...
      if (!$.data(this, "plugin_" + pluginName)) {
        $.data(this, "plugin_" + pluginName, new LiquidPreloader(this, pluginOptions));
      }
    });
  };
})(jQuery);
...
(function ($) {
  ...
  $.fn[pluginName] = function (options) {
    return this.each(function () {
      ...
      if (!$.data(this, "plugin_" + pluginName)) {
        $.data(this, "plugin_" + pluginName, new LiquidSubmenu(this, pluginOptions));
      }
    });
  };
})(jQuery);
...
(function ($) {
  ...
  $.fn[pluginName] = function (options) {
    return this.each(function () {
      ...
      if (!$.data(this, "plugin_" + pluginName)) {
        $.data(this, "plugin_" + pluginName, new LiquidMobileNav(this, pluginOptions));
      }
    });
  };
})(jQuery);
...
(function ($) {
  ...
  $.fn[pluginName] = function (options) {
    return this.each(function () {
      ...
      if (!$.data(this, "plugin_" + pluginName)) {
        $.data(this, "plugin_" + pluginName, new LiquidButton(this, pluginOptions));
      }
    });
  };
})(jQuery);
...
(function ($) {
  ...
  function LiquidFitText(element, options) {
    this.element = element;
    this.options = $.extend({}, defaults, options);
    this._defaults = defaults;
    this._name = pluginName;
  ...
  $.fn[pluginName] = function (options) {
    return this.each(function () {
      ...
      if (!$.data(this, "plugin_" + pluginName)) {
        $.data(this, "plugin_" + pluginName, new LiquidFitText(this, pluginOptions));
      }
    });
  };
})(jQuery);
...
(function ($) {
  ...
  $.fn[pluginName] = function (options) {
    return this.each(function () {
      ...
      if (!$.data(this, "plugin_" + pluginName)) {
        $.data(this, "plugin_" + pluginName, new LiquidInView(this, pluginOptions));
      }
    });
  };
})(jQuery);
...
(function ($) {
  ...
  $.fn[pluginName] = function (options) {
    return this.each(function () {
      ...
      if (!$.data(this, "plugin_" + pluginName)) {
        $.data(this, "plugin_" + pluginName, new LiquidFullscreenNav(this, pluginOptions));
      }
    });
  };
})(jQuery);
...
(function ($) {
  ...
  $.fn[pluginName] = function (options) {
    return this.each(function () {
      ...
      if (!$.data(this, "plugin_" + pluginName)) {
        $.data(this, "plugin_" + pluginName, new LiquidToggle(this, pluginOptions));
      }
    });
  };
})(jQuery);
...
(function ($) {
  ...
  $.fn[pluginName] = function (options) {
    return this.each(function () {
      ...
      if (!$.data(this, "plugin_" + pluginName)) {
        $.data(this, "plugin_" + pluginName, new LiquidResponsiveBG(this, pluginOptions));
      }
    });
  };
})(jQuery);
...
(function ($) {
  ...
  $.fn[pluginName] = function (options) {
    return this.each(function () {
      ...
      if (!$.data(this, "plugin_" + pluginName)) {
        $.data(this, "plugin_" + pluginName, new LiquidStickyHeader(this, pluginOptions));
      }
    });
  };
})(jQuery);
...
(function ($) {
  ...
  $.fn[pluginName] = function (options) {
    return this.each(function () {
      ...
      if (!$.data(this, "plugin_" + pluginName)) {
        $.data(this, "plugin_" + pluginName, new LiquidStickyFooter(this, pluginOptions));
      }
    });
  };
})(jQuery);
...
(function ($) {
  ...
  $.fn[pluginName] = function (options) {
    return this.each(function () {
      ...
      if (!$.data(this, "plugin_" + pluginName)) {
        $.data(this, "plugin_" + pluginName, new LiquidCustomCursor(this, pluginOptions));
      }
    });
  };
})(jQuery);
...
(function ($) {
  ...
  let defaults = {};
  function LiquidAccordion(element, options) {
    this.element = element;
    this.$element = $(element);
    this.isBS5 = typeof bootstrap !== 'undefined';
    this.options = $.extend({}, defaults, options);
  ...
  $.fn[pluginName] = function (options) {
    return this.each(function () {
      ...
      if (!$.data(this, "plugin_" + pluginName)) {
        $.data(this, "plugin_" + pluginName, new LiquidAccordion(this, pluginOptions));
      }
    });
  };
})(jQuery);
...
(function ($) {
  ...
  class AjaxLoadMore {
    ...
    loadItems(event) {
      ...
      const nextPageUrl = this.$element.attr('href') || this.$element.data('href');
        ...
        success: data => {
          ...
          imagesLoaded($newItems.get(), () => {
            if (newNextPageUrl && nextPageUrl != newNextPageUrl) {
              ...
              this.$element.data('href', newNextPageUrl);
            } else {
  ...
  $.fn[pluginName] = function (options) {
    return this.each(function () {
      ...
      if (!$.data(this, "plugin_" + pluginName)) {
        $.data(this, "plugin_" + pluginName, new AjaxLoadMore(this, pluginOptions));
      }
    });
  };
})(jQuery);
...
(function ($) {
  ...
  class AnimatedFrames {
    ...
    initEvents() {
      ...
      const onWheel = liquidThrottle(event => {
        ...
        if (target !== this.DOM.el && !this.DOM.el.contains(target)) return;
  ...
  $.fn[pluginName] = function (options) {
    return this.each(function () {
      ...
      if (!$.data(this, "plugin_" + pluginName)) {
        $.data(this, "plugin_" + pluginName, new AnimatedFrames(this, pluginOptions));
      }
    });
  };
})(jQuery);
...
(function ($) {
  ...
  $.fn[pluginName] = function (options) {
    return this.each(function () {
      ...
      if (!$.data(this, "plugin_" + pluginName)) {
        $.data(this, "plugin_" + pluginName, new AsymmetricSlider(this, pluginOptions));
      }
    });
  };
})(jQuery);
...
(function ($) {
  ...
  $.fn[pluginName] = function (options) {
    return this.each(function () {
      ...
      if (!$.data(this, "plugin_" + pluginName)) {
        $.data(this, "plugin_" + pluginName, new BackToTop(this, pluginOptions));
      }
    });
  };
})(jQuery);
...
(function ($) {
  ...
  $.fn[pluginName] = function (options) {
    return this.each(function () {
      ...
      if (!$.data(this, "plugin_" + pluginName)) {
        $.data(this, "plugin_" + pluginName, new BgColor(this, pluginOptions));
      }
    });
  };
})(jQuery);
...
(function ($) {
  ...
  $.fn[pluginName] = function (options) {
    return this.each(function () {
      ...
      if (!$.data(this, "plugin_" + pluginName)) {
        $.data(this, "plugin_" + pluginName, new LiquidAnimatedIcon(this, pluginOptions));
      }
    });
  };
})(jQuery);
...
(function ($) {
  ...
  function LiquidCarousel(element, options) {
    this._defaults = defaults;
    this._name = pluginName;
    this.options = {
      ...defaults,
  ...
  LiquidCarousel.prototype = {
    ...
    doSomethingCrazyWithFilter() {
      ...
      if (!firstVisibleCell) return false;
  ...
  $.fn[pluginName] = function (options) {
    return this.each(function () {
      ...
      if (!$.data(this, "plugin_" + pluginName)) {
        $.data(this, "plugin_" + pluginName, new LiquidCarousel(this, pluginOptions));
      }
    });
  };
})(jQuery);
...
(function ($) {
  ...
  $.fn[pluginName] = function (options) {
    return this.each(function () {
      ...
      if (!$.data(this, "plugin_" + pluginName)) {
        $.data(this, "plugin_" + pluginName, new CarouselFalcate(this, pluginOptions));
      }
    });
  };
})(jQuery);
...
(function ($) {
  ...
  $.fn[pluginName] = function (options) {
    return this.each(function () {
      ...
      if (!$.data(this, "plugin_" + pluginName)) {
        $.data(this, "plugin_" + pluginName, new LiquidCarouselStack(this, pluginOptions));
      }
    });
  };
})(jQuery);
...
(function ($) {
  ...
  function LiquidCarouselV3d(element, options) {
    this.element = element;
    this.options = $.extend({}, defaults, options);
    this._defaults = defaults;
    this._name = pluginName;
  ...
  $.fn[pluginName] = function (options) {
    return this.each(function () {
      ...
      if (!$.data(this, "plugin_" + pluginName)) {
        $.data(this, "plugin_" + pluginName, new LiquidCarouselV3d(this, pluginOptions));
      }
    });
  };
})(jQuery);
...
(function ($) {
  ...
  class LiquidMegamenu {
    ...
    resizeWindow() {
      ...
      $(document).on('lqd-header-sticky-change', () => {
        if (this.$element.is(':visible') && this.isInCustomMenu && this.$element.closest('.main-header').length || this.$element.closest('.lqd-show-onstuck')) {
          onResize();
        }
      });
    }
  ...
  $.fn[pluginName] = function (options) {
    return this.each(function () {
      ...
      if (!$.data(this, "plugin_" + pluginName)) {
        $.data(this, "plugin_" + pluginName, new LiquidMegamenu(this, pluginOptions));
      }
    });
  };
})(jQuery);
...
(function ($) {
  ...
  $.fn[pluginName] = function (options) {
    return this.each(function () {
      ...
      if (!$.data(this, "plugin_" + pluginName)) {
        $.data(this, "plugin_" + pluginName, new LiquidMegamenuSlide(this, pluginOptions));
      }
    });
  };
})(jQuery);
...
(function ($) {
  ...
  $.fn[pluginName] = function (options) {
    return this.each(function () {
      ...
      if (!$.data(this, "plugin_" + pluginName)) {
        $.data(this, "plugin_" + pluginName, new LiquidCountdown(this, pluginOptions));
      }
    });
  };
...
(function ($) {
  ...
  function LiquidCounter(element, options) {
    this._defaults = defaults;
    this._name = pluginName;
    this.options = $.extend({}, defaults, options);
    this.element = element;
  ...
  $.fn[pluginName] = function (options) {
    return this.each(function () {
      ...
      if (!$.data(this, "plugin_" + pluginName)) {
        $.data(this, "plugin_" + pluginName, new LiquidCounter(this, pluginOptions));
      }
    });
  };
})(jQuery);
...
(function ($) {
  ...
  class LiquidDistortedImageGallery {
    constructor(element, options) {
      this.element = element;
      this.$element = $(element);
      this.options = $.extend({}, defaults, options);
  ...
  $.fn[pluginName] = function (options) {
    return this.each(function () {
      ...
      if (!$.data(this, "plugin_" + pluginName)) {
        $.data(this, "plugin_" + pluginName, new LiquidDistortedImageGallery(this, pluginOptions));
      }
    });
  };
})(jQuery);
...
(function ($) {
  ...
  $.fn[pluginName] = function (options) {
    return this.each(function () {
      ...
      if (!$.data(this, "plugin_" + pluginName)) {
        $.data(this, "plugin_" + pluginName, new LiquidDynamicShape(this, pluginOptions));
      }
    });
  };
})(jQuery);
...
(function ($) {
  ...
  class LiquidFormInputs {
    ...
    initSelect() {
      const $selectElement = this.$element.find('select').not('.select2-hidden-accessible, .select, .woo-rating, #bbp_stick_topic_select, #bbp_topic_status_select, #bbp_forum_id, .woocommerce-widget-layered-nav-dropdown, .elementor-field-textual, .wc-pao-addon-select, .quform-field, .choicesjs-select, .choices__input');
  ...
  $.fn[pluginName] = function (options) {
    return this.each(function () {
      ...
      if (!$.data(this, "plugin_" + pluginName)) {
        $.data(this, "plugin_" + pluginName, new LiquidFormInputs(this, pluginOptions));
      }
    });
  };
})(jQuery);
jQuery(document).ready(function ($) {
  $('form, .lqd-filter-dropdown, .widget').not('[name="chbs-form"], .frm-fluent-form, .hub-booking-form, .geodir-listing-search, .wpforms-form, .wc-block-checkout__form, .woocommerce-shipping-calculator').liquidFormInputs();
});
(function ($) {
  'use strict';
  ...
  $.fn[pluginName] = function (options) {
    return this.each(function () {
      ...
      if (!$.data(this, "plugin_" + pluginName)) {
        $.data(this, "plugin_" + pluginName, new LiquidHover3d(this, pluginOptions));
      }
    });
  };
})(jQuery);
...
(function ($) {
  ...
  $.fn[pluginName] = function (options) {
    return this.each(function () {
      ...
      if (!$.data(this, "plugin_" + pluginName)) {
        $.data(this, "plugin_" + pluginName, new LiquidIconboxCircle(this, pluginOptions));
      }
    });
  };
})(jQuery);
...
(function ($) {
  ...
  $.fn[pluginName] = function (options) {
    return this.each(function () {
      const pluginOptions = $(this).data('plugin-options') || options;
      if (!$.data(this, "plugin_" + pluginName)) {
        $.data(this, "plugin_" + pluginName, new LiquidImageComparison(this, pluginOptions));
      }
    });
  };
})(jQuery);
...
(function ($) {
  ...
  class LiquidImageTrail {
    constructor(element, options) {
      ...
      this.images = [];
      [...this.DOM.imgArrayContainer.querySelectorAll('.lqd-img-trail-img')].forEach(img => this.images.push(new LiquidImageTrailImg(img)));
  ...
  $.fn[pluginName] = function (options) {
    return this.each(function () {
      ...
      if (!$.data(this, "plugin_" + pluginName)) {
        $.data(this, "plugin_" + pluginName, new LiquidImageTrail(this, pluginOptions));
      }
    });
  };
})(jQuery);
...
(function ($) {
  ...
  class LiquidLightBox {
    constructor(element, options) {
      ...
      try {
        ...
        console.warn(`Invalid selector: ${href}`, this.element);
        return;
      }
      this.targets = document.querySelectorAll(href);
      this.target = false;
      this.$target = false;
  ...
  $.fn[pluginName] = function (options) {
    return this.each(function () {
      ...
      if (!$.data(this, "plugin_" + pluginName)) {
        $.data(this, "plugin_" + pluginName, new LiquidLightBox(this, pluginOptions));
      }
    });
  };
})(jQuery, window, document);
...
(function ($) {
  ...
  $.fn[pluginName] = function (options) {
    return this.each(function () {
      ...
      if (!$.data(this, "plugin_" + pluginName)) {
        $.data(this, "plugin_" + pluginName, new LiquidMasonry(this, pluginOptions));
      }
    });
  };
})(jQuery);
...
(function ($) {
  ...
  $.fn[pluginName] = function (options) {
    return this.each(function () {
      ...
      if (!$.data(this, "plugin_" + pluginName)) {
        $.data(this, "plugin_" + pluginName, new LiquidStickyRow(this, pluginOptions));
      }
    });
  };
})(jQuery);
...
(function ($) {
  ...
  $.fn[pluginName] = function (options) {
    return this.each(function () {
      ...
      if (!$.data(this, "plugin_" + pluginName)) {
        $.data(this, "plugin_" + pluginName, new LiquidParticles(this, pluginOptions));
      }
    });
  };
})(jQuery);
...
(function ($) {
  ...
  class LiquidPin {
        ...
        ScrollTrigger.matchMedia({
          [`${breakpoint}`]: async () => {
            this.ST = ScrollTrigger.create({
              ...
              pinReparent,
              onEnter: () => {
                this.element.classList.add('lqd-pin-is-stuck');
              },
              onLeave: () => {
                this.element.classList.remove('lqd-pin-is-stuck');
              },
              onLeaveBack: () => {
                this.element.classList.remove('lqd-pin-is-stuck');
              },
      ...
      return fastdomPromised.measure(() => {
        ...
        if (duration === 'last-link') {
          ...
          if (lastLinkHref !== '' && lastLinkHref.startsWith('#') && $(lastLinkHref).length) {
            lastLinkTarget = $(lastLinkHref);
          } else {
            lastLinkTarget = $liquidContents;
          }
          duration = `+=${lastLinkTarget.offset().top + lastLinkTarget.outerHeight() - (this.rect.top + window.scrollY) - this.offset}`;
        }
        return duration;
      });
    }
    ...
    events() {
      $(document).on('lqd-header-sticky-change lqd-masonry-layout-complete lqd-carousel-initialized', async () => {
        await this.measure();
  ...
  $.fn[pluginName] = function (options) {
    return this.each(function () {
      ...
      if (!$.data(this, "plugin_" + pluginName)) {
        $.data(this, "plugin_" + pluginName, new LiquidPin(this, pluginOptions));
      }
    });
  };
})(jQuery);
...
(function ($) {
  ...
  $.fn[pluginName] = function (options) {
    return this.each(function () {
      ...
      if (!$.data(this, "plugin_" + pluginName)) {
        $.data(this, "plugin_" + pluginName, new LiquidProgressbar(this, pluginOptions));
      }
    });
  };
})(jQuery);
...
(function ($) {
  ...
  class LiquidResponsiveAccordion {
    constructor(element, options) {
      this._defaults = defaults;
      this._name = pluginName;
      this.options = {
  ...
  $.fn[pluginName] = function (options) {
    return this.each(function () {
      ...
      if (!$.data(this, "plugin_" + pluginName)) {
        $.data(this, "plugin_" + pluginName, new LiquidResponsiveAccordion(this, pluginOptions));
      }
    });
  };
})(jQuery);
...
(function ($) {
  ...
  $.fn[pluginName] = function (options) {
    return this.each(function () {
      ...
      if (!$.data(this, "plugin_" + pluginName)) {
        $.data(this, "plugin_" + pluginName, new LiquidReveal(this, pluginOptions));
      }
    });
  };
})(jQuery);
...
(function ($) {
  ...
  $.fn[pluginName] = function (options) {
    return this.each(function () {
      ...
      if (!$.data(this, "plugin_" + pluginName)) {
        $.data(this, "plugin_" + pluginName, new LiquidSetActiveOnhover(this, pluginOptions));
      }
    });
  };
})(jQuery);
...
(function ($) {
  ...
  $.fn[pluginName] = function (options) {
    return this.each(function () {
      ...
      if (!$.data(this, "plugin_" + pluginName)) {
        $.data(this, "plugin_" + pluginName, new LiquidShrinkBorders(this, pluginOptions));
      }
    });
  };
})(jQuery);
...
(function ($) {
  ...
  $.fn[pluginName] = function (options) {
    return this.each(function () {
      ...
      if (!$.data(this, "plugin_" + pluginName)) {
        $.data(this, "plugin_" + pluginName, new LiquidSlideElement(this, pluginOptions));
      }
    });
  };
})(jQuery);
...
(function ($) {
  ...
  $.fn[pluginName] = function (options) {
    return this.each(function () {
      ...
      if (!$.data(this, "plugin_" + pluginName)) {
        $.data(this, "plugin_" + pluginName, new LiquidStack(this, pluginOptions));
      }
    });
  };
})(jQuery);
...
(function ($) {
  ...
  $.fn[pluginName] = function (options) {
    return this.each(function () {
      ...
      if (!$.data(this, "plugin_" + pluginName)) {
        $.data(this, "plugin_" + pluginName, new LiquidStickyStack(this, pluginOptions));
      }
    });
  };
})(jQuery);
...
(function ($) {
  ...
  $.fn[pluginName] = function (options) {
    return this.each(function () {
      ...
      if (!$.data(this, "plugin_" + pluginName)) {
        $.data(this, "plugin_" + pluginName, new LiquidStretchElement(this, pluginOptions));
      }
    });
  };
})(jQuery);
...
(function ($) {
  ...
  class LiquidTab {
    ...
    onShown(event) {
      ...
      if (this.options.trigger !== 'hover' && (!liquidIsMobile() && offsetTop <= $liquidWindow.scrollTop() - 15 || liquidIsMobile() && (offsetTop > $liquidWindow.scrollTop() + window.innerHeight || $liquidWindow.scrollTop() > offsetTop))) {
        $('html, body').stop().animate({
  ...
  $.fn[pluginName] = function (options) {
    return this.each(function () {
      ...
      if (!$.data(this, "plugin_" + pluginName)) {
        $.data(this, "plugin_" + pluginName, new LiquidTab(this, pluginOptions));
      }
    });
  };
})(jQuery);
...
(function ($) {
  ...
  $.fn[pluginName] = function (options) {
    return this.each(function () {
      ...
      if (!$.data(this, "plugin_" + pluginName)) {
        $.data(this, "plugin_" + pluginName, new LiquidTypewriter(this, pluginOptions));
      }
    });
  };
})(jQuery);
...
(function ($) {
  ...
  $.fn[pluginName] = function (inlineVideoOptions, youtubeOptions) {
    return this.each(function () {
      ...
      if (!$.data(this, "plugin_" + pluginName)) {
        $.data(this, "plugin_" + pluginName, new LiquidVideoBg(this, inlineVidOptions, YTOptions));
      }
    });
  };
})(jQuery, window, document);
...
(function ($) {
  ...
  $.fn[pluginName] = function (options) {
    return this.each(function () {
      ...
      if (!$.data(this, "plugin_" + pluginName)) {
        $.data(this, "plugin_" + pluginName, new LiquidVideoTrigger(this, pluginOptions));
      }
    });
  };
})(jQuery);
...
(function ($) {
  ...
  $.fn[pluginName] = function (options) {
    return this.each(function () {
      ...
      if (!$.data(this, "plugin_" + pluginName)) {
        $.data(this, "plugin_" + pluginName, new LiquidWebGLHover(this, pluginOptions));
      }
    });
  };
})(jQuery);
...
(function ($) {
  ...
  $.fn[pluginName] = function (options) {
    return this.each(function () {
      ...
      if (!$.data(this, "plugin_" + pluginName)) {
        $.data(this, "plugin_" + pluginName, new LiquidSlideshow(this, pluginOptions));
      }
    });
  };
})(jQuery);
...
(function ($) {
  ...
  $.fn[pluginName] = function (options) {
    return this.each(function () {
      ...
      if (!$.data(this, "plugin_" + pluginName)) {
        $.data(this, "plugin_" + pluginName, new LiquidWoo(this, pluginOptions));
      }
    });
  };
})(jQuery);
...
(function ($) {
  ...
  $.fn[pluginName] = function (options) {
    return this.each(function () {
      ...
      if (!$.data(this, "plugin_" + pluginName)) {
        $.data(this, "plugin_" + pluginName, new LiquidZIndex(this, pluginOptions));
      }
    });
  };
})(jQuery);
...
(function ($) {
  ...
  $.fn[pluginName] = function (options) {
    return this.each(function () {
      ...
      if (!$.data(this, "plugin_" + pluginName)) {
        $.data(this, "plugin_" + pluginName, new LiquidSectionScroll(this, pluginOptions));
      }
    });
  };
})(jQuery);
...
(function ($) {
  ...
  class LiquidLocalScroll {
    ...
    onClick(event) {
      ...
      this.$element.closest('.lqd-fancy-menu').find('.lqd-custom-menu-dropdown-btn').siblings('ul').collapse('hide');
    }
    onScroll() {
  ...
  $.fn[pluginName] = function (options) {
    return this.each(function () {
      ...
      if (!$.data(this, "plugin_" + pluginName)) {
        $.data(this, "plugin_" + pluginName, new LiquidLocalScroll(this, pluginOptions));
      }
    });
  };
})(jQuery);
...
(function ($) {
  ...
  $.fn[pluginName] = function (options) {
    return this.each(function () {
      ...
      if (!$.data(this, "plugin_" + pluginName)) {
        $.data(this, "plugin_" + pluginName, new LiquidRowBG(this, pluginOptions));
      }
    });
  };
})(jQuery);
...
(function ($) {
  ...
  $.fn[pluginName] = function (options) {
    return this.each(function () {
      ...
      if (!$.data(this, "plugin_" + pluginName)) {
        $.data(this, "plugin_" + pluginName, new LiquidSlideshowBG(this, pluginOptions));
      }
    });
  };
})(jQuery);
...
(function ($) {
  ...
  $.fn[pluginName] = function (options) {
    return this.each(function () {
      ...
      if (!$.data(this, "plugin_" + pluginName)) {
        $.data(this, "plugin_" + pluginName, new LiquidSplitText(this, pluginOptions));
      }
    });
  };
})(jQuery);
...
(function ($) {
  ...
  $.fn[pluginName] = function (options) {
    return this.each(function () {
      ...
      if (!$.data(this, plugin)) {
        $.data(this, `plugin_${pluginName}`, new LiquidCustomAnimations(this, pluginOptions));
      }
    });
  };
})(jQuery);
...
(function ($) {
  ...
  $.fn[pluginName] = function (options) {
    return this.each(function () {
      ...
      if (!$.data(this, "plugin_" + pluginName)) {
        $.data(this, "plugin_" + pluginName, new LiquidTextRotator(this, pluginOptions));
      }
    });
  };
})(jQuery);
...
(function ($) {
  ...
  $.fn[pluginName] = function (options, fromOpts, toOpts) {
    return this.each(function () {
      const disableOnMobile = liquidParams?.disableParallaxOnMobile != null ? liquidParams.disableParallaxOnMobile : true;
      const pluginOptions = {
        disableOnMobile,
      ...
      if (!$.data(this, "plugin_" + pluginName)) {
        if (pluginOptions.disableOnMobile && liquidIsMobile()) return;
        $.data(this, "plugin_" + pluginName, new LiquidParallax(this, pluginOptions, parallaxFrom, parallaxTo));
      }
    });
  };
})(jQuery);
...
(function ($) {
  ...
  $.fn[pluginName] = function (options) {
    return this.each(function () {
      ...
      if (!$.data(this, "plugin_" + pluginName)) {
        $.data(this, "plugin_" + pluginName, new LiquidTransitionDelay(this, pluginOptions));
      }
    });
  };
})(jQuery);
...
(function ($) {
  ...
  $.fn[pluginName] = function (options) {
    return this.each(function () {
      ...
      if (!$.data(this, "plugin_" + pluginName)) {
        $.data(this, "plugin_" + pluginName, new LiquidMoveElement(this, pluginOptions));
      }
    });
  };
})(jQuery);
...
(function ($) {
  ...
  class LiquidScrollIndicator {
    ...
    init() {
      const stackEnabled = $liquidContents.length && $liquidContents[0].hasAttribute('data-liquid-stack');
      stackEnabled ? this.initMutationObserver() : this.initialTrigger();
    }
    getScrollingTarget() {
      const {
        scrollingTarget
  ...
  $.fn[pluginName] = function (options) {
    return this.each(function () {
      ...
      if (!$.data(this, "plugin_" + pluginName)) {
        $.data(this, "plugin_" + pluginName, new LiquidScrollIndicator(this, pluginOptions));
      }
    });
  };
})(jQuery);
...
(function ($) {
  ...
  $.fn[pluginName] = function (options) {
    return this.each(function () {
      ...
      if (!$.data(this, "plugin_" + pluginName)) {
        $.data(this, "plugin_" + pluginName, new LiquidTimer(this, pluginOptions));
      }
    });
  };
})(jQuery);
...
(function ($) {
  ...
  $.fn[pluginName] = function (options) {
    return this.each(function () {
      ...
      if (!$.data(this, "plugin_" + pluginName)) {
        $.data(this, "plugin_" + pluginName, new LiquidCurtain(this, pluginOptions));
      }
    });
  };
})(jQuery);
...
(function ($) {
  ...
  $.fn[pluginName] = function (options) {
    return this.each(function () {
      ...
      if (!$.data(this, "plugin_" + pluginName)) {
        $.data(this, "plugin_" + pluginName, new LiquidCutout(this, pluginOptions));
      }
    });
  };
})(jQuery);
...
(function ($) {
  ...
  const pluginName = 'liquidStackedSections';
  let defaults = {
    innerElementSelector: '.lqd-stacked-sections-inner',
    itemsSelector: '.lqd-stacked-sections-item',
    contentsSelector: '.lqd-stacked-sections-content',
    imagesSelector: '.lqd-stacked-sections-image',
    navSelector: '.lqd-stacked-sections-nav',
    navButtonsSelector: '.lqd-stacked-sections-nav-button',
    navButtonsProgressSelector: '.lqd-stacked-sections-nav-button-progress'
  };
  class LiquidStackedSections {
    constructor(element, options) {
      this._defaults = defaults;
      this._name = pluginName;
      this.options = {
      ...
      this.element = element;
      this.innerElement = this.element.querySelector(this.options.innerElementSelector);
      this.items = this.element.querySelectorAll(this.options.itemsSelector);
      this.contents = this.element.querySelectorAll(this.options.contentsSelector);
      this.images = this.element.querySelectorAll(this.options.imagesSelector);
      this.nav = this.element.querySelector(this.options.navSelector);
      this.navButtons = this.nav.querySelectorAll(this.options.navButtonsSelector);
      this.itemsST = [];
      this.mm = gsap.matchMedia();
      this.scrollSmoothEnabled = 'liquidLenis' in window;
      this.init();
    }
    init() {
      this.mm.add('(min-width: 1025px)', () => {
        ...
        const onButtonClick = event => {
          ...
          const st = this.itemsST.at(index);
          if (!st) return;
          if (this.scrollSmoothEnabled) {
            liquidLenis.scrollTo(st.start + st.start * 0.05);
          } else {
            $('html, body').animate({
              scrollTop: st.start + st.start * 0.05
            }, 350);
          }
        };
        ...
        return () => {
          this.navButtons.forEach(btn => btn.removeEventListener('click', onButtonClick));
        };
      });
    }
    initInnerElement() {
      ScrollTrigger.create({
        trigger: this.innerElement,
        endTrigger: this.element,
        pin: true,
        start: `top top+=${document.querySelector('#wpadminbar')?.offsetHeight ?? 0}`,
        end: 'bottom bottom',
        onUpdate: st => {
          this.element.style.setProperty('--progress', st.progress.toFixed(3) * 100);
        }
      });
    }
    initItems() {
      let prevItemsHeight = 0;
      function animateContent(elements = [], dir = 'enter') {
        gsap.to(elements, {
      ...
      this.items.forEach((item, index) => {
        ...
        const imageFigure = image.querySelector('figure');
        const imageImage = image.querySelector('img');
        const contentWidgets = content.querySelectorAll('[data-element_type=widget]');
        const navButton = this.navButtons[index];
        const navButtonProgress = navButton?.querySelector(this.options.navButtonsProgressSelector);
        const tl = gsap.timeline();
        const itemHeight = item.offsetHeight;
        tl.to(navButtonProgress, {
          scaleX: 1
        });
        tl.to(imageFigure, {
          y: 0,
        ...
        const st = ScrollTrigger.create({
          trigger: item,
          pinnedContainer: this.innerElement,
          animation: tl,
          start: `top+=${prevItemsHeight} top`,
          end: `+=${itemHeight}`,
          scrub: true,
          onEnter: () => {
            item.classList.add('active');
            animateContent(contentWidgets, 'enter');
          },
          onLeave: () => {
            if (index === this.items.length - 1) return;
            item.classList.remove('active');
            animateContent(contentWidgets, 'leave');
          },
          onEnterBack: () => {
            item.classList.add('active');
            animateContent(contentWidgets, 'enter');
        ...
        this.itemsST.push(st);
        prevItemsHeight += itemHeight;
      });
    }
    destroy() {
      this.mm.revert();
  ...
  $.fn[pluginName] = function (options) {
    return this.each(function () {
      const pluginOptions = {
        ...$(this).data('stacked-sections-options'),
        ...options
      };
      if (!$.data(this, "plugin_" + pluginName)) {
        $.data(this, "plugin_" + pluginName, new LiquidStackedSections(this, pluginOptions));
      }
    });
  };
})(jQuery);
jQuery(document).ready(function ($) {
  $('[data-lqd-stacked-sections=true]').liquidStackedSections();
});
