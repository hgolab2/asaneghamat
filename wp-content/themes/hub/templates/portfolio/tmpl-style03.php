<div class="carousel-item col-lg-<?php $this->get_column_class() ?> col-md-6 col-xs-12 <?php $this->entry_term_classes() ?> <?php $this->entry_term_filter_ids(); ?>">
				...
				<div class="lqd-pf-item-inner">
					...
					<div class="lqd-pf-img overflow-hidden border-radius-6 pos-rel mb-5">
						...
						<span class="lqd-pf-overlay-bg lqd-overlay d-flex align-items-center justify-content-center">
							<?php 
								if ( is_array( $custom_arrow_icon ) ) {
									$custom_arrow_icon = sprintf( '<i class="%s"></i>', esc_attr( $custom_arrow_icon['value'] ) );
								}
								echo $custom_arrow_icon;
							?>
						</span>
